...
import { Card, CardImg, CardText, CardBody, Breadcrumb, BreadcrumbItem, Button, Label, Row, Col, Modal, ModalHeader, ModalBody } from 'reactstrap';
    ...
    if(props.campsite) {
        return (
            <div className="container">
                ...
                <div className="row"><RenderCampsite campsite={props.campsite} />
